    ...
    <div className="min-h-screen bg-[#050505] text-foreground">
      <header className="border-b border-[#1a1a1a] bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3">
          ...
          <span className="rounded-full border border-[#1a1a1a] bg-[#111111] px-3 py-1 font-mono text-[10px] font-medium uppercase tracking-widest text-[#555555]">udost\u0119pniony raport</span>
        </div>
      </header>
      <main className="mx-auto max-w-2xl px-4 py-8">
        {payload.healthScore !== null && (
          <section className="mb-8 rounded-2xl border border-[#1a1a1a] bg-[#0a0a0a] p-6 text-center">
            ...
            <p className="text-xs text-[#888888]">na 100 punkt\u00F3w</p>
          </section>
        )}
        ...
        <section className="mb-6 grid grid-cols-3 gap-3">
          <div className="rounded-xl border border-[#1a1a1a] bg-[#0a0a0a] p-4 text-center"><p className="font-mono text-xl font-bold text-foreground">{formatNumber(payload.messageCount)}</p><p className="mt-1 text-[10px] uppercase tracking-wider text-[#555555]">wiadomo\u015Bci</p></div>
        ...
        {payload.viralScores && (
          <section className="mb-6 rounded-2xl border border-[#1a1a1a] bg-[#0a0a0a] p-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-lg border border-[#1a1a1a] bg-[#111111] p-3"><p className="mb-1 text-[10px] uppercase tracking-wider text-[#555555]">Kompatybilno\u015B\u0107</p><p className="font-mono text-2xl font-bold text-[#3b82f6]">{payload.viralScores.compatibilityScore}%</p></div>
        ...
        <section className="mb-8 rounded-2xl border border-[#2a2a2a] bg-gradient-to-br from-[#0a0a1a] to-[#0a0a0a] p-8 text-center">
          ...
          <p className="mb-5 text-sm text-[#888888]">Wrzu\u0107 eksport z Messengera i odkryj co kryje si\u0119 mi\u0119dzy wierszami.</p>
          <a href="/" className="inline-flex items-center gap-2 rounded-lg bg-[#3b82f6] px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-[#2563eb]">Analizuj swoj\u0105 rozmow\u0119<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10m0 0L9 4m4 4L9 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></a>
        </section>
        <div className="mb-12 text-center"><p className="text-xs text-[#555555]">Ponad <span className="font-semibold text-[#888888]">1,000</span> rozm\u00F3w przeanalizowanych</p></div>
