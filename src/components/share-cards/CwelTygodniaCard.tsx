...
interface CwelTygodniaCardProps {
  result: CwelTygodniaResult;
  cardRef?: RefObject<HTMLDivElement | null>;
}

export default function CwelTygodniaCard({ result, cardRef: externalRef }: CwelTygodniaCardProps) {
  const internalRef = useRef<HTMLDivElement>(null);
  const cardRef = externalRef ?? internalRef;
  const { download, isDownloading } = useCardDownload(cardRef, 'podtekst-cwel-tygodnia');
